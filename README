...
```
Pertuz, A. (2025). VelRecover: A Python-based tool for interpolating 2D seismic velocity data from sparse velocity analysis. GitHub. https://github.com/username/velrecover
```
